...
const app = _vue.createApp((0, _appVueDefault.default));
...
class VueElement extends BaseClass {
     ...
     */ _resolveDef() {
        ...
        const resolve = (def)=>{
            ...
            for (const key of rawKeys.map((0, _shared.camelize)))Object.defineProperty(this, key, {
                get () {
...
function getTransitionRawChildren(children, keepComment = false, parentKey) {
    ...
    if (keyedFragmentCount > 1) for(let i = 0; i < ret.length; i++)ret[i].patchFlag = -2 /* BAIL */ ;
    return ret;
}
...
function createSetupContext(instance) {
    const expose = (exposed)=>{
        if (0, instance.exposed) warn(`expose() should be called only once per setup().`);
...
let initialize = ()=>{
    ...
    script.__scopeId = "data-v-f61c20";
    script.__file = "/Users/jae0/BootCamp_work/Vue/packageVue/src/App.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = "f61c20-hmr";
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord("f61c20-hmr", script)) __VUE_HMR_RUNTIME__.reload("f61c20-hmr", script);
        }, 0);
    });
}
exports.default = script;

},{"29158dae54139136":"iiJmB","8a4954974a3e2a08":"evi43","7e9898e9b122e745":"h0MjM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","f5f81ab60053088e":"1aWWh"}],"iiJmB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = {
    data () {
        return {
            title: "Hi! first install Vue Package"
        };
    }
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("h1", null, (0, _vue.toDisplayString)($data.title), 1 /* TEXT */ );
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender("f61c20-hmr", render);
});
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1aWWh":[function() {},{}]},["icZzK","8lqZg"], "8lqZg", "parcelRequire9e4b")
